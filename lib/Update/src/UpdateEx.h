...
class UpdateClassEx {
  public:
    ...
    UpdateClassEx(UpdateProcessor * processor = NULL);
    ~UpdateClassEx();
    /*
      This callback will be called when Update is receiving data
    */
    UpdateClassEx& onProgress(THandlerFunction_Progress fn);
    UpdateClassEx& approveReboot(THandlerFunction_ApproveOTA fn);
